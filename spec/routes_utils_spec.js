...
describe('Utils: ', function() {
  ...
  describe('updateInvestorPortfolio', function() {
    ...
    it('should add user to the portfolio if investment is a give', function() {
      ...
      var newInvestment = { user: 'Matt', userId: '123', amount: 10, percentage: 0.5, dividend: 1 };
    ...
    it('should remove the investment if it is entirely revoked', function() {
      var existingInvestment = { _id: '1', user: 'Matt', userId: '123', amount: 10, percentage: 0.1, dividend: 10 };
      var existingInvestment2 = { _id: '2', user: 'Bob', userId: '456', amount: 10, percentage: 0.1, dividend: 10 };
      existingPortfolio = [{ reps: 100, category: 'Coding', investments: [existingInvestment, existingInvestment2] }];
      amount = -10;
