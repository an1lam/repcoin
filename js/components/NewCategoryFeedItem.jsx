...
var NewCategoryFeedItem = React.createClass({
    ...
    event =
      <span>
        <Link to='profile' params={{userId: this.props.event.userId}}>
            {this.props.event.username}</Link> just created the category <Link to="category" params={{category: this.props.event.category}}>
...
module.exports = NewCategoryFeedItem;
