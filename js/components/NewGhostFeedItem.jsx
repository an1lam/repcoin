...
var NewGhostFeedItem = React.createClass({
    ...
    event =
      <span>
        <Link to='profile' params={{userId: this.props.event.userId}}>
            {this.props.event.username}</Link> just created the ghost <Link to="profile" params={{userId: this.props.event.ghostId}}>
          '{this.props.event.ghostName}'</Link>!</span>;
    return (
...
module.exports = NewGhostFeedItem;
